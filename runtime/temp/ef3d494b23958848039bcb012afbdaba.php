<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpstudy\PHPTutorial\WWW\kedi\public/../application/admin\view\.\index.html";i:1538213684;s:74:"D:\phpstudy\PHPTutorial\WWW\kedi\application\admin\view\public_header.html";i:1538213684;s:74:"D:\phpstudy\PHPTutorial\WWW\kedi\application\admin\view\public_footer.html";i:1538213684;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/static/admin/org/img/profile_small.jpg" /></span>
                    ...
                    <li>
                        <a class="J_menuItem" href="../user/user_list.html?usertoken=<?php echo $usertoken; ?>"><i class="fa fa-columns"></i> <span class="nav-label">管理员</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">系统管理 </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="../auth/auth_list.html?usertoken=<?php echo $usertoken; ?>">权限管理</a>
                            </li>
                            <li><a class="J_menuItem" href="../group/group_list.html?usertoken=<?php echo $usertoken; ?>">权限组管理</a>
                            </li>
                             <li><a class="J_menuItem" href="../menu/menu_list.html?usertoken=<?php echo $usertoken; ?>">菜单管理</a>
                            </li>
                             <li><a class="J_menuItem" href="../Nversions/Nversions_list.html?usertoken=<?php echo $usertoken; ?>">版本管理</a>
                            </li>
                             <li><a class="J_menuItem" href="../Nconfig/create.html?usertoken=<?php echo $usertoken; ?>">系统设置</a>
                             <li><a class="J_menuItem" href="../Nbutton_Lang/nbuttonlang_list.html?usertoken=<?php echo $usertoken; ?>">语言设置</a>
                             <li><a class="J_menuItem" href="../Common/clear_cache.html?usertoken=<?php echo $usertoken; ?>">清除缓存</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="welcome.html?usertoken=<?php echo $usertoken; ?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                </div>
            </div>
